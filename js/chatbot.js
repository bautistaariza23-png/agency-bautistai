...
(function () {
  ...
  var SCREENS = {
    ...
    sobre: {
      bubbles: [
        bi(
          'Soy Bautista, diseñador UX/UI y desarrollador web. Creador de flujos con IA. Trabajo con emprendedores y negocios que necesitan un sitio desde cero, y con quienes ya tienen uno pero está confuso, lento o desactualizado — no hago solo sitios bonitos, hago sitios que funcionan.',
          "I'm Bautista, a UX/UI designer and web developer. AI workflow creator. I work with entrepreneurs and businesses that need a site from scratch, and with those who already have one but it's confusing, slow or outdated — I don't make pretty sites, I make sites that work."
        ),
